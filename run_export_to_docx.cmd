...
python export-user-image-to-docx.py -i  %INPUT_EXCEL%   --user-snapshot-root %INPUT_USER_SNAPSHOT_IMAGES_ROOT% -x %INPUT_SS_IMAGE_ROOT%  --docx-template-file  %INPUT_DOCX_TEMPLATE%  -o %OUTPUT_DOCX_FILENAME% --user-snapshot-types 身份证,毕业证,资质证书,合同,社保 --sheet-name-user 人员 --col-user-name 姓名 
